                    ...
                    if self.args.ud_range == 1:
                        ...
                        for iterat in range(len(h)):
                            if h[iterat] or t[iterat] in key_ent:
                                ...
                                t_1.append(t[iterat])
                                l_1.append(l[iterat])
                        h_1 = torch.LongTensor(h_1).to(self.device)
                        r_1 = torch.LongTensor(r_1).to(self.device)
                        t_1 = torch.LongTensor(t_1).to(self.device)
                        l_1 = torch.LongTensor(l_1).to(self.device)
